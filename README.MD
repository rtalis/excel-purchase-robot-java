...
2.  **Run the Main Robot:**
    ...
    - After 5 seconds, the robot will:
        ...
        - Read the company number from the column to the left side of the purchase/NF number.
...
-   [`src/main/java/com/rt/robotexcel/demo/`](src/main/java/com/rt/robotexcel/demo/)
    ...
    -   [`ExcelPurchaseRobot.java`](src/main/java/com/rt/robotexcel/demo/ExcelPurchaseRobot.java) - Main application entry point.
